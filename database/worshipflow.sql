...
INSERT INTO `escalas` (`id`, `titulo`, `status`, `observacoes`, `ministerio_id`) VALUES
(1, 'Escala - Culto de Domingo', 'PUBLICADA', 'Passagem de som as 18:00.', 1);
...
(1, 'Grande E O Senhor', 'Comunidade', 'G', 74, NULL, 1),
(2, 'Te Louvarei', 'Ministerio Local', 'D', 96, NULL, 1),
(3, 'Santo Para Sempre', 'Worship', 'A', 68, NULL, 1),
(4, 'adad', 'asdad', 'd', 44, '', NULL);
