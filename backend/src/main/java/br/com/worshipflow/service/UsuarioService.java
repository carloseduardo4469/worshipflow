...
public class UsuarioService {
    ...
    public List<UsuarioResponse> listar() {
        return usuarioRepository.findAll().stream().map(authService::toResponse).toList();
    }
    ...
    public List<EquipeResponse> listarEquipe() {
        return usuarioRepository.findByStatusMinisterio(StatusMinisterio.ATIVO).stream()
